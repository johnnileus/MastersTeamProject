...
void EnemyTestScene::InitScene(GameWorld* world) {
    ...
    for (int i = 0; i < 5; ++i) {
        newMeleeEnemy.Invoke(AddMeleeEnemyToWorld(world, this->navGrid, Vector3(10, 3, 10), 5.0f, 1.0f));
        newRangedEnemy.Invoke(AddRangedEnemyToWorld(world, this->navGrid, Vector3(10, 3, 10), 2.5f, 2.5f));
        newGhostEnemy.Invoke(AddGhostEnemyToWorld(world, this->navGrid, Vector3(10, 3, 10), 1.0f, 5.0f));
    }
}